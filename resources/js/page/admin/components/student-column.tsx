...
export const columns: ColumnDef<UserDto>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <p className="py-2 font-semibold dark:text-white">
                {row.getValue('name')}
            </p>
        ),
    },
    ...
    },
    {
        ...
        header: ({ column }) => {
            return (
                <div className="m-1 flex w-full items-center justify-between gap-5">
                    <Select
                        value={
                            (column.getFilterValue() as string)?.replace(
                                / /g,
                                '_',
                            ) ?? ''
                        }
    ...
    },
    {
        ...
        header: ({ column }) => {
            return (
                <div className="flex w-full cursor-pointer items-center justify-between gap-5">
                    <Select
                        value={column.getFilterValue() as string}
                        onValueChange={(value) =>
                            column.setFilterValue(
                                value === 'Tout' ? undefined : value,
                            )
                        }
                    >
                        <SelectTrigger className="w-full bg-gray-200">
