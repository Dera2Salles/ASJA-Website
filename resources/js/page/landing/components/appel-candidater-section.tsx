            ...
            <div className="section-shell">
                <div className="rounded-[28px] bg-[#35cf7f] px-6 py-12 text-center text-[#161d1a] sm:px-10 sm:py-16 lg:px-[56px] lg:py-[72px]">
                    ...
                    <motion.p
                        ...
                        className="mx-auto mt-4 max-w-[620px] text-base leading-[1.58] font-medium text-[#161d1a]/90 sm:mt-5 sm:text-lg"
                    >
                    ...
                    >
                        <a
                            href="#"
                            className="inline-flex min-h-[52px] w-full items-center justify-center rounded-full bg-[#161d1a] px-8 text-[15px] font-bold text-white transition-colors hover:bg-white hover:text-[#161d1a] sm:w-auto sm:px-[34px]"
                        >
