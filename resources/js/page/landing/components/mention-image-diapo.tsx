...
export const MentionDiapo = ({ props }: { props: MentionDiapoProps[] }) => {
    ...
    return (
        <div className="w-full bg-gray-50 py-8 transition-colors duration-300 dark:bg-gray-900">
            <Carousel
                setApi={setApi}
                plugins={[
                    Autoplay({
            ...
            >
                <CarouselContent>
                    {props.map((item, index) => (
                        ...
                        >
                            <div className="p-1">
                                <div className="relative aspect-video overflow-hidden rounded-2xl shadow-lg md:aspect-[16/9]">
                                    <img
                                        src={item.image}
                                        alt={item.altText}
