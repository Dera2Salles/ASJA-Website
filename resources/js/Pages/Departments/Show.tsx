    ...
    return (
        <section className="relative flex min-h-[60vh] w-full items-end overflow-hidden">
            {image ? (
                ...
                <div className="absolute inset-0 bg-[#161d1a]" />
            )}
                    ...
                    <main className="flex-1">
                        ...
                        >
                            <div className="section-shell pt-14 sm:pt-16 lg:pt-[80px]">
                                <div className="rounded-[28px] bg-[#35cf7f] px-6 py-12 text-center text-[#161d1a] sm:px-10 sm:py-16 lg:px-[56px] lg:py-[72px]">
                                    ...
                                    <p className="mx-auto mt-4 max-w-[620px] text-base leading-[1.58] font-medium text-[#161d1a]/90 sm:mt-5 sm:text-lg">
                                    ...
                                    <div className="mx-auto mt-8 flex w-full max-w-[420px] flex-col gap-3 sm:mt-9 sm:max-w-none sm:flex-row sm:flex-wrap sm:justify-center sm:gap-3.5">
                                        <Link
                                            href="/#contact"
                                            className="inline-flex min-h-[52px] w-full items-center justify-center gap-2 rounded-full bg-[#161d1a] px-8 text-[15px] font-bold text-white transition-colors hover:bg-white hover:text-[#161d1a] sm:w-auto sm:px-[34px]"
                                        >
                                            Nous contacter
                                        ...
                                        <Link
                                            href="/#filiere"
                                            className="inline-flex min-h-[52px] w-full items-center justify-center rounded-full border border-[#161d1a]/35 px-8 text-[15px] font-semibold text-[#161d1a] hover:bg-[#161d1a]/10 sm:w-auto sm:px-[32px]"
                                        >
